...
// BDZ
// This constant value was found by doing a binary search on the space of 1 to 255
// and keeping the highest value that did not exhibit ticks. 6 and higher were
// problematic. 1 to 5 all worked.
// Later note: solidchoppers.h version was tested on stock OVJ 3.1A with
// aHX.c on a known failure case. This code version was maybe never tested
// much. It seems to just be spitting out 90s for hX.c.
...
CP make_cp(CP cp)
{
   ...
   if (!strcmp(cp.ch,"fr") ) {
      ...
      abort_message("make_cp() Error: cp channel != 'fr' or 'to': it equals (%s).", cp.ch);
   }
   ...
   if (strcmp(cp.sh,"c") == 0) {
      ...
      cp.b = 1.0e12;
      // TODO: should we be setting cp.d to something???
   }
   
   // now let's check the validity of the inputs 
   
   if (mean + fabs(cp.d) == 0) {
      
      abort_message("make_cp() Error: mean + fabs(cp.d) is nonsensical (== 0). Aborting.\n");
   }
   
   if (cp.n90 <= 1) {
      
      abort_message("make_cp() Error: cp.n90 is nonsensical (<= 1). Aborting.\n");
   }
   
   if (cp.t <= 0) {
      
      abort_message("make_cp() Error: cp.t is nonsensical (<= 0). Aborting.\n");
   }
  
   if (cp.b <= 0.0) {

      abort_message("make_cp() Error: cp.b is nonsensical (<= 0). Aborting.\n");
   }
   ...
   if((fp = fopen(shapepath,"w"))==NULL) {
      abort_message("Error in make_cp(): can not create file %s!\n", shapepath);
   }
   ...
   // BDZ: temporarily removing since I am not sure this is right
   //if (aCurrent < 0.0) aCurrent = 0.0;
   //if (aCurrent > 1023.0) aCurrent = 1023.0;
   aLast = aCurrent;
   ph = 0;
   t = 0;
   ntick = 0;
...
void _initcp_(CP cp, double lamplitude)
{
   ...
   if (strcmp(cp.ch,"fr") == 0)
      ...
      abort_message("Error from _initcp_(): cp channel != 'fr' or 'to': it equals (%s).", cp.ch);
   }
   ...
   switch(nchRamp) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _initcp_(): Invalid Ramp Channel! %d\n", nchRamp);
         psg_abort(1);
         break;
   }
   dps_on();
...
void _setcp_(CP cp)
{
   ...
   if (strcmp(cp.ch,"fr") == 0) {
      ...
      abort_message("_setcp() Error: cp channel != 'fr' or 'to': it equals (%s).", cp.ch);
   }
   if (strcmp(chRamp,"obs") == 0)       nchRamp = 1;
   else if (strcmp(chRamp,"dec") == 0)  nchRamp = 2;
   else if (strcmp(chRamp,"dec2") == 0) nchRamp = 3;
   ...
   switch(nchConst) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _setcp_(): Invalid Const Channel! %d\n", nchConst);
         psg_abort(1);
         break;
   }
   ...
   switch(nchRamp) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _setcp_(): Invalid Ramp Channel! %d\n", nchRamp);
         psg_abort(1);
         break;
   }
   ...
   switch(nchRamp) {
      case 1:
         if ((cp.t > 0.0) && ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0))) {
            setobswfg(cp.pattern,cp.n90*DTCK,90.0,aRamp);
         }
         else {
            obspwrf(aRamp);
         }
      ...
      case 2:
         if ((cp.t > 0.0) && ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0))) {
            setdecwfg(cp.pattern,cp.n90*DTCK,90.0,aRamp);
         }
         else {
            decpwrf(aRamp);
         }
      ...
      case 3:
         if ((cp.t > 0.0) && ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0))) {
            setdec2wfg(cp.pattern,cp.n90*DTCK,90.0,aRamp);
         }
         else {
            dec2pwrf(aRamp);
         }
      ...
      case 4:
         if ((cp.t > 0.0) && ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0))) {
            setdec3wfg(cp.pattern,cp.n90*DTCK,90.0,aRamp);
         }
         else {
            dec3pwrf(aRamp);
         }
...
void _cp_(CP cp, int phase1, int phase2)
{
   ...
   switch(nchConst) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _cp_(): Invalid Const Channel! %d\n", nchConst);
         psg_abort(1);
         break;
   }
   ...
   switch(nchRamp) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _cp_(): Invalid Ramp Channel! %d\n", nchRamp);
         psg_abort(1);
         break;
   }
   ...
   switch(nchRamp) {
      case 1:
         if (cp.t > 0.0) {
            if ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0)) {
               obswfgon(cp.pattern,cp.n90*DTCK,90.0,p2,cp.offstdelay);
            }
         }
         if (p1 != 0) {
            txphase(rphase);
      ...
      case 2:
         if (cp.t > 0.0) {
            if ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0)) {
               decwfgon(cp.pattern,cp.n90*DTCK,90.0,p2,cp.offstdelay);
            }
         }
         if (p1 != 0) {
            decphase(rphase);
      ...
      case 3:
         if (cp.t > 0.0) {
            if ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0)) {
               dec2wfgon(cp.pattern,cp.n90*DTCK,90.0,p2,cp.offstdelay);
            }
         }
         if (p1 != 0) {
            dec2phase(rphase);
      ...
      case 4:
         if (cp.t > 0.0) {
            if ((strcmp(cp.sh,"c") != 0) || (fabs(cp.of) >= 1.0)) {
               dec3wfgon(cp.pattern,cp.n90*DTCK,90.0,p2,cp.offstdelay);
            }
         }
         if (p1 != 0) {
            dec3phase(rphase);
...
void _clearcp_(CP cp)
{
   ...
   switch(nchRamp) {
      ...
      case 4:
         ...
         break;
      default:
         printf("Error from _clearcp_(): Invalid Ramp Channel! %d\n", nchRamp);
         psg_abort(1);
         break;
   }
   dps_on();
...
void MPinitializer(MPSEQ *mp,int npw,int nph,int no,int na,int ng,int nBase,int nSuper)
{
   ...
   if (PWRF_DELAY > 0.0) mp->n90 = 16; // Change from 16 to 40 CMR 11/17/23   // change back to 16 on 2/16/24 CMR
   else mp->n90 = 8; // Change from 8 to 40 CMR 11/17/23   // change back to 8 2/16/24 CMR: 7/20/24: must be 8 or RFDR timings are wrong.
   mp->preset1 = 0;
   mp->preset2 = 0;
...
// Obtain nmin ,the ticks per step, from seq.n90
   ...
   int nmin = seq.n90;  // Must be set in the get function  CMR 2/7/23 this is where seq.n90 is used to determine minimum step size
   ...
   if (strcmp(r.sh,"c") == 0 && fabs(r.of)  < 1.0) {
      ...
      switch (POL) {
         ...
         case DOWN_UP:
            ...
            break;
         default:
            printf("Error in make_ramp. Cannot determine RAMP polarity! %d\n", POL);
            psg_abort(1);
            break;
      }
      aCurrent = (double)((int)(aCurrent + 0.5));
...
//Make the four tangent shapes for DREAM
    ...
    // BDZ: this call was not in master. Maybe calling it twice was a bug.
    //  make_ramp(d.Ruu);
...
//=======================================================
//make_r2t() - Calculate three Tangent RAMPS for R2T
//=======================================================

R2T make_r2t(R2T r2t) {
    extern RAMP make_ramp(RAMP r);

//Make the three tangent shapes for R2T

    r2t.in = make_ramp(r2t.in);
    r2t.drm = make_ramp(r2t.drm);
    r2t.out = make_ramp(r2t.out);
...
//Calculate the shape and count ticks down from the initial "nrpul"
   ...
   while (nrpuls > 0) {
      if (nrpuls == s.pars.n) {               // Always write the first step
         ...
         state =  s.get_state(t,s.pars);
         aCurrent = (double)((int)(state.a + 0.5));
         // BDZ TODO 11-1-23: are we missing a clamp aCurrent to [0,1023] here?
         phShapeCurrent = state.p;
         gate = state.g;
         continue;
      }
...
// Supply INOVA Start Delays
   ...
   if (PWRF_DELAY > 0.0) s.pars.n90 = 40; // Change from 16 to 40 CMR 11/17/2023
   else s.pars.n90 = 40; // Change from 8 to 40 CMR 11/17/2023
   s.pars.preset1 = 0;
   s.pars.preset2 = 0;
...
void _setmpseq(MPSEQ seq)
{
   ...
   switch (chnl) {
     case 1:
        obsunblank();
        if (seq.nelem > 0) {
           setobswfg(seq.pattern,seq.n90*DTCK,90.0,seq.a);
        }
        else {
           obspwrf(seq.a);
        }
     ...
     case 2:
        decunblank();
        if (seq.nelem > 0) {
           setdecwfg(seq.pattern,seq.n90*DTCK,90.0,seq.a);
        }        
        else {
           decpwrf(seq.a);
        }
     ...
     case 3:
        dec2unblank();
        if (seq.nelem > 0) {
           setdec2wfg(seq.pattern,seq.n90*DTCK,90.0,seq.a);
        }
        else {
           dec2pwrf(seq.a);
        }
     ...
     case 4:
        dec3unblank();
        if (seq.nelem > 0) {
           setdec3wfg(seq.pattern,seq.n90*DTCK,90.0,seq.a);
        }
        else {
           dec3pwrf(seq.a);
        }
...
void _mpseq(MPSEQ seq, int phase)
{
   ...
   switch (chnl) {
      case 1:
         ...
         if (seq.nelem > 0) {
            obswfgon(seq.pattern,seq.n90*DTCK,90.0,p2,seq.offstdelay);
         }
         if ((p1 != 0) && (m1 == 0)) {
            txphase(phase);
            xmtron();
      ...
      case 2:
         ...
         if (seq.nelem > 0) {
            decwfgon(seq.pattern,seq.n90*DTCK,90.0,p2,seq.offstdelay);
         }
         if ((p1 != 0) && (m1 == 0)) {
            decphase(phase);
            decon();
      ...
      case 3:
         ...
         if (seq.nelem > 0) {
            dec2wfgon(seq.pattern,seq.n90*DTCK,90.0,p2,seq.offstdelay);
         }
         if ((p1 != 0) && (m1 == 0)) {
            dec2phase(phase);
            dec2on();
      ...
      case 4:
         ...
         if (seq.nelem > 0) {
            dec3wfgon(seq.pattern,seq.n90*DTCK,90.0,p2,seq.offstdelay);
         }
         if (p1 != 0) {
            dec3phase(phase);
            dec3on();
...
void _clearmpseq(MPSEQ seq)
{
   ...
   if (!strcmp(seq.ch,"obs")) chnl = 1;
      ...
      printf("_clearmpseq() Error: Undefined Channel! %s\n", seq.ch);
      psg_abort(1);
   }
...
void _setshape(SHAPE s)
{
   ...
   switch (chnl) {
     case 1:
        obsunblank();
        if (s.pars.t > 0.0) {
           setobswfg(s.pars.pattern,s.pars.n90*DTCK,90.0,s.pars.a);
        }
        else { 
           obspwrf(s.pars.a);
        }
     ...
     case 2:
        decunblank();
        if (s.pars.t > 0.0) {
           setdecwfg(s.pars.pattern,s.pars.n90*DTCK,90.0,s.pars.a);
        }        
        else { 
           decpwrf(s.pars.a);
        }
     ...
     case 3:
        dec2unblank();
        if (s.pars.t > 0.0) {
           setdec2wfg(s.pars.pattern,s.pars.n90*DTCK,90.0,s.pars.a);
        }        
        else { 
           dec2pwrf(s.pars.a);
        }
     ...
     case 4:
        dec3unblank();
        if (s.pars.t > 0.0) {
           setdec3wfg(s.pars.pattern,s.pars.n90*DTCK,90.0,s.pars.a);
        }
        else { 
           dec3pwrf(s.pars.a);
        }
...
void _shape(SHAPE s, codeint phase)
{
   ...
   switch (chnl) {
      case 1:
         ...
         if (s.pars.t > 0.0) {
            obswfgon(s.pars.pattern,s.pars.n90*DTCK,90.0,p2,s.pars.offstdelay);
         }
         if (p1 != 0) {
            txphase(phase);
            xmtron();
      ...
      case 2:
         ...
         if (s.pars.t > 0.0) {
            decwfgon(s.pars.pattern,s.pars.n90*DTCK,90.0,p2,s.pars.offstdelay);
         }
         if (p1 != 0) {
            decphase(phase);
            decon();
      ...
      case 3:
         ...
         if (s.pars.t > 0.0) {
            dec2wfgon(s.pars.pattern,s.pars.n90*DTCK,90.0,p2,s.pars.offstdelay);
         }
         if (p1 != 0) {
            dec2phase(phase);
            dec2on();
      ...
      case 4:
         ...
         if (s.pars.t > 0.0) {
            dec3wfgon(s.pars.pattern,s.pars.n90*DTCK,90.0,p2,s.pars.offstdelay);
         }
         if (p1 != 0) {
            dec3phase(phase);
            dec3on();
   ...
   switch (chnl) {
      case 1:
         ...
         if ((r.t > 0.0) && ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0))) {
            setobswfg(r.pattern,r.n90*DTCK,90.0,ampl);
         }
         else {
            obspwrf(ampl);
         }
      ...
      case 2:
         decunblank();
         if ((r.t > 0.0) && ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0))) {
            setdecwfg(r.pattern,r.n90*DTCK,90.0,ampl);
         }
         else {
            decpwrf(ampl);
         }
      ...
      case 3:
         dec2unblank();
         if ((r.t > 0.0) && ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0))) {
            setdec2wfg(r.pattern,r.n90*DTCK,90.0,ampl);
         }
         else {
            dec2pwrf(ampl);
         }
      ...
      case 4:
         dec3unblank();
         if ((r.t > 0.0) && ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0))) {
            setdec3wfg(r.pattern,r.n90*DTCK,90.0,ampl);
         }
         else {
            dec3pwrf(ampl);         }
         break;
...
void _ramp(RAMP r, codeint phase)
{
   ...
   switch (chnl) {
      case 1:
         ...
         if (r.t > 0.0) {
            if ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0)) {
               obswfgon(r.pattern,r.n90*DTCK,90.0,p2,r.offstdelay);
            }
         }
         if (p1 != 0) {
            txphase(phase);
      ...
      case 2:
         ...
         if (r.t > 0.0) {
            if ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0)) {
               decwfgon(r.pattern,r.n90*DTCK,90.0,p2,r.offstdelay);
            }
         }
         if (p1 != 0) {
            decphase(phase);
      ...
      case 3:
         ...
         if (r.t > 0.0) {
            if ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0)) {
               dec2wfgon(r.pattern,r.n90*DTCK,90.0,p2,r.offstdelay);
            }
         }
         if (p1 != 0) {
            dec2phase(phase);
      ...
      case 4:
         ...
         if (r.t > 0.0) {
            if ((strcmp(r.sh,"c") != 0) || (fabs(r.of) >= 1.0)) {
               dec3wfgon(r.pattern,r.n90*DTCK,90.0,p2,r.offstdelay);
            }
         }
         if (p1 != 0) {
            dec3phase(phase);
...
//=============================================
//Underscore Function to Output a R2T Pulse
//=============================================

void _r2t(R2T r2t, codeint phase)
{
   _ramp(r2t.in,phase);
   _ramp(r2t.drm,phase);
   _ramp(r2t.out,phase);
