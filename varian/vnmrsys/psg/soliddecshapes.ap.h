...
#ifdef WE_INCLUDED_BIOSOLID_DECSHAPES
...
#define WE_INCLUDED_SOLID_DECSHAPES
...
void _spinal(SPINAL dec)
{
   ...
   aSPINAL = dec.a;
   chnl = 0;
   if (!strcmp(dec.ch,"obs")) {chnl = 1; printf("chnl=1");} //added print statements for debugging
   else if (!strcmp(dec.ch,"dec")) {chnl = 2; printf("chnl=2");printf("dec.ch %s \n",dec.ch);}
   else if (!strcmp(dec.ch,"dec2")) {chnl = 3; printf("chnl=3");}
   else if (!strcmp(dec.ch,"dec3")) {chnl = 4; printf("chnl=4");}
   else {
