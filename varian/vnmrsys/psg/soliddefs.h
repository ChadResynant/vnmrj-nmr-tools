...
// BDZ adopted from OVJ master 1-31-24: more accurate

#define TWOPI (2.0 * 3.14159265358979323846) 

#define DTCK 12.50e-9

// BDZ adopted NMIN from OVJ master 1-31-24: float instead of int
...
// BDZ adopted DPH from OVJ master 1-31-24: turns out to be more accurate and ends in a well rounded number 
...
#define NCH 8
#else
#define NCH 8 // BDZ was 5 for us: let's match OVJ 3.1A at the moment
#endif
...
#define NPATTERN 512
#else
#define NPATTERN 512 // BDZ was 32 for us: let's match OVJ3.1A at the moment
#endif
...
#define NSUFFIX 256 // BDZ was 13 for us: let's match MASTER at the moment
...
//BDZ let's match OVJ 3.1A at the moment
//#ifdef MATCH_MASTER
...
// BDZ NOTE: RT2 is a Rienstra lab thing. Not in OVJ master. Was it
//   retired? Our code uses it a lot.
...
typedef struct {
  ...
  // BDZ: adding OVJ's behavior to our own structure
...
// BDZ let's match OVJ 3.1A for now
//#ifdef MATCH_MASTER
...
//#else
//   double dp[4];         //generic params: doubles
//   int    ip[4];         //generic params: ints
//#endif
