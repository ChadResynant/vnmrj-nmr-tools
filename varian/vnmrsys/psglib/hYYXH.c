...
static int table1[8] =  {0,2,0,2,2,0,2,0};          // phH90
static int table2[4] =  {1,1,1,1};                  // phHhy
static int table3[4] =  {0,0,0,0};                  // phYhy
static int table4[4] =  {3,3,3,3};                  // ph1Y90 store F4
static int table5[4] =  {1,1,1,1};                  // ph2Y90 recover F4
static int table6[8] =  {0,0,0,0,0,0,0,0};          // phYmix1 Y-Y mixing

static int table8[4] =  {3,3,3,3};                  // ph3Y90 store F3
static int table9[4] =  {1,1,1,1};                  // ph4Y90 recover F3
static int table10[16]= {0,0,0,0,0,0,0,0, 2,2,2,2,2,2,2,2};          // phYyx Y to X CP
static int table11[4] = {0,0,0,0};                  // phXyx Y to X CP

static int table12[4] = {1,1,1,1};                  // ph1X90 store F2
static int table13[4] = {3,3,1,1};                  // ph2X90 recover F2
static int table14[4] = {0,0,0,0};                  // phXxh X to H CP
static int table15[4] = {1,1,1,1};                  // phHxh X to H CP

static int table16[8] = {0,0,0,0,0,0,0,0};          // ph1H90 H-H mixing
static int table17[8] = {2,2,2,2,2,2,2,2};          // ph2H90 H-H mixing
static int table18[4] = {0,0,0,0};                  // phHrfdr H-H mixing
static int table19[4] = {0,0,0,0};                  // phHpxy H presat
